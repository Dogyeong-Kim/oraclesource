...
-- 사용자 관리
-- 오라클은 테이블, 인덱스, 뷰 둥 사용자별로 여러 객체를 생성하므로 업무별 사용자를 생성한 후에 각 사용자
...
-- 0RA-01045 : 사용자 C##TEST1는 CREATE SESSION 귄한을 가지고있지 않음; 로그온이 거절되었습니다
-- 1. 사용자 생성
...
-- 사용자 스키마에 객체가 존재한다면 CASCATE옵션을 사용해서 제거
